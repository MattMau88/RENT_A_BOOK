...
ActiveRecord::Schema.define(version: 2020_06_02_083044) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.index ["owner_id_id"], name: "index_books_on_owner_id_id"
  end
  ...
  add_foreign_key "books", "users", column: "owner_id_id"
